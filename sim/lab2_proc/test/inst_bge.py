...
def gen_srcs_dep_taken_test():
  return [
    gen_br2_srcs_dep_test( 5, "bge", 7, 1, True ),
    gen_br2_srcs_dep_test( 4, "bge", 7, 2, True ),
    gen_br2_srcs_dep_test( 3, "bge", 7, 3, True ),
    gen_br2_srcs_dep_test( 2, "bge", 7, 4, True ),
    gen_br2_srcs_dep_test( 1, "bge", 7, 5, True ),
...
#    print("src0 " + str(src0))
#    # Branch taken, operands are equal or src0 > src1
